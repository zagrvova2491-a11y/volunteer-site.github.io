class EcoConnectApp {
    ...
    updateUIForUserType() {
        const createEventCard = document.getElementById('createEventDashboardCard');
        const createEventFab = document.getElementById('createEventBtn');
        const welcomeTitle = document.getElementById('welcomeTitle');
        
        if (this.currentUser.accountType === 'curator') {
            if (createEventCard) createEventCard.style.display = 'block';
            if (createEventFab) createEventFab.style.display = 'flex';
            if (welcomeTitle) welcomeTitle.textContent = 'Добро пожаловать, Куратор!';
        } else {
            if (createEventCard) createEventCard.style.display = 'none';
            if (createEventFab) createEventFab.style.display = 'none';
